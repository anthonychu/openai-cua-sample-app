...
- [Azure Container Apps dynamic sessions](https://learn.microsoft.com/azure/container-apps/sessions-code-interpreter) (remote browser, requires account)
...
| `SessionsCodeInterpreterBrowser`  | sessions  | `linux`   | Remote Ubuntu desktop environment | [Azure Container Apps dynamic sessions](https://learn.microsoft.com/azure/container-apps/sessions-code-interpreter) POOL_MANAGEMENT_ENDPOINT in `.env` |
